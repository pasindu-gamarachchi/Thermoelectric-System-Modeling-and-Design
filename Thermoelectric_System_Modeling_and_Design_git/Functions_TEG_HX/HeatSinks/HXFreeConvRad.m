...
% Free Convection using equation for convection
% Radiation from outter fin surface added, 05/24
  function [Qc h TEMC Ra Qr] = HXFreeConvRad(Tcb, Tamb)
...
Qr = A*(Boltz)*(ep_Cu)*(Tcb_K^4 - Tamb_K^4);
