...
% Edited for V2 : 03/09/2017
% Convection Coeff using delt T from source by Guan, Liu et Zhang

 function [QTot] = HXMicroFinsFiniteElementV2(Tb, Tamb)
...
for i = 1:Nx
    for j = 1:Nz
        ...
        [Qf_fe, TTip] = FEFinV2(TambM(i,j,:),Tb, Tamb, elemsize );
        Qf_feM(i,j) = Qf_fe;
        TtipM(i,j) = TTip;
    end
end
